...
-- Sample user follows (only if you want to test with existing data)
-- INSERT INTO public.user_follows (user_id, school_id, notifications_enabled) VALUES
-- ('your-test-user-id', 'school-uuid-1', true),
-- ('your-test-user-id', 'school-uuid-2', false);
